...
import type { Finding, MeshRating, RepoBaseline, RepoPolicies } from './types.js';

const BASELINE_FILE = '.policymesh-baseline.json';

const RATING_RANK: Record<MeshRating, number> = {
  none: 0,
  low: 1,
  medium: 2,
  high: 3,
...
export async function loadBaseline(root: string): Promise<BaselineResult> {
...
function isMeshRating(value: unknown): value is MeshRating {
