 ...
 */
export function privilegedToken(server: Pick<McpServer, 'command' | 'args'>): string | undefined {
...
export function detectPrivilegedCommands(policies: RepoPolicies): Finding[] {
