...
test('release metadata is prepared for v0.3.0 Action users', async () => {
  ...
  assert.match(readme, /uses: Conalh\/PolicyMesh@v0\.3\.0/);
});
...
test('issue templates collect detector and team validation feedback', async () => {
  ...
  assert.match(teamPilot, /Conalh\/PolicyMesh@v0\.3\.0/);
