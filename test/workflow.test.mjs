...
test('release metadata is prepared for v0.1.11 Action users', async () => {
  ...
  assert.equal(packageLock.version, '0.1.11');
  assert.equal(packageLock.packages[''].version, '0.1.11');
  assert.match(readme, /uses: Conalh\/PolicyMesh@v0\.1\.11/);
});
